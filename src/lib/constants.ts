...
export const ALL_INFLUENCERS: Influencer[] = [
  { name: "Ronaldinho Gaúcho", handle: "@ronaldinho", slug: "ronaldinho", niche: "Esporte", followers: "155.3M", engagement: "3.2%", platforms: ["Instagram", "TikTok"], bio: "Maior ícone do futebol brasileiro, conectando marcas com milhões de fãs ao redor do mundo.", color: "#00F0D0", badges: ["Top of mind"], order: 1 },
  { name: "Anitta", handle: "@anitta", slug: "anitta", niche: "Música", followers: "64.5M", engagement: "2.8%", platforms: ["Instagram", "TikTok", "YouTube"], bio: "Artista global e maior referência brasileira na indústria musical internacional.", color: "#E0F050", badges: ["Top of mind", "Destaque"], order: 2 },
  { name: "Whindersson Nunes", handle: "@whindersson", slug: "whindersson-nunes", niche: "Humor", followers: "59.1M", engagement: "5.1%", platforms: ["YouTube", "Instagram", "TikTok"], bio: "Um dos maiores comediantes digitais do Brasil, com alcance massivo em múltiplas plataformas.", color: "#D0F060", badges: ["Destaque"], order: 3 },
  { name: "Virgínia Fonseca", handle: "@virginia", slug: "virginia-fonseca", niche: "Lifestyle", followers: "50.2M", engagement: "4.8%", platforms: ["Instagram", "YouTube", "TikTok"], bio: "Criadora de conteúdo e empresária, referência em lifestyle e maternidade no Brasil.", color: "#80F090", badges: ["Em alta"], order: 4 },
  { name: "Felipe Neto", handle: "@felipeneto", slug: "felipe-neto", niche: "Entretenimento", followers: "46.3M", engagement: "3.9%", platforms: ["YouTube", "Instagram", "Twitter"], bio: "Pioneiro do conteúdo digital brasileiro, com presença massiva em entretenimento e opinião.", color: "#D0F060", badges: [], order: 5 },
  { name: "Juliette Freire", handle: "@juliette", slug: "juliette-freire", niche: "Beleza", followers: "32.8M", engagement: "6.2%", platforms: ["Instagram", "TikTok"], bio: "Fenômeno cultural e referência em beleza, autenticidade e representatividade nordestina.", color: "#E0F050", badges: ["Em alta"], order: 6 },
  { name: "Jade Picon", handle: "@jadepicon", slug: "jade-picon", niche: "Moda", followers: "22.4M", engagement: "4.1%", platforms: ["Instagram", "TikTok"], bio: "Influenciadora e modelo, referência em moda e tendências para a geração Z.", color: "#80F090", badges: ["Exclusivo"], order: 7 },
  { name: "Gkay", handle: "@gaborrecidente", slug: "gkay", niche: "Humor", followers: "20.5M", engagement: "6.8%", platforms: ["Instagram", "TikTok", "YouTube"], bio: "Comediante e influenciadora, conhecida por seu conteúdo irreverente e eventos icônicos.", color: "#E0F050", badges: [], order: 8 },
  { name: "Lucas Rangel", handle: "@lucasrangel", slug: "lucas-rangel", niche: "Humor", followers: "18.2M", engagement: "7.3%", platforms: ["TikTok", "Instagram", "YouTube"], bio: "Comediante digital com conteúdo viral e alto engajamento entre o público jovem.", color: "#00F0D0", badges: ["Em alta", "Novo"], order: 9 },
  { name: "Casimiro Miguel", handle: "@casimiro", slug: "casimiro-miguel", niche: "Esporte", followers: "15.7M", engagement: "8.5%", platforms: ["YouTube", "TikTok", "Instagram"], bio: "Maior streamer e comentarista esportivo do Brasil, referência em entretenimento ao vivo.", color: "#00F0D0", badges: ["Em alta"], order: 10 },
